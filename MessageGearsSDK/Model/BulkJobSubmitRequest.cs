...
namespace MessageGears.Model
{
	...
	public class BulkJobSubmitRequest : JobRequest
	{
		...
		/// <summary>
		/// An optional correlation id which can be used to associate your internal job id with a MessageGears job.
		/// This value will be provided back as a part of every event generated by the system and may make it easier to place data in to your internal systems.
		/// </summary>
